    ...
    <div className='flex justify-center'>
      <div className="card bg-neutral shadow-lg rounded-lg p-6 w-full max-w-sm mt-16 mb-16"> 
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className='w-full max-w-sm mt-4'>
          ...
          <div className='mb-4'>
            <label htmlFor='telephone' className='block text-sm font-medium text-neutral-content'>
              Telephone
            </label>
            <input
              type='text'
          ...
          <div className='mb-4'>
            <label htmlFor='address' className='block text-sm font-medium text-neutral-content'>
              Address
            </label>
            <input
              type='text'
